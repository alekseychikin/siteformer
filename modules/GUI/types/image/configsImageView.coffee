...
module.exports = View
  ...
  events:
    ...
    "keyup input: @configs-image-path": (e) ->  @frequency 500, => @model.updatePath e.target.value
    "change: @configs-image-path": (e) ->  @model.updatePath e.target.value
    "change keyup input blur: @configs-image-s3-access-key": (e) -> @frequency 500, => @model.updateS3AccessKey e.target.value
    "change keyup input blur: @configs-image-s3-secret-key": (e) -> @frequency 500, => @model.updateS3SecretKey e.target.value
