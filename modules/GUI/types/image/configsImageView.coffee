...
module.exports = View
  ...
  events:
    ...
    "change keyup input: @configs-image-s3-access-key": (e) -> @frequency 500, => @model.updateS3AccessKey e.target.value
    "change keyup input: @configs-image-s3-secret-key": (e) -> @frequency 500, => @model.updateS3SecretKey e.target.value
