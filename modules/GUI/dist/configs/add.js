...
})(function ()
{
  ...
  return function (obj)
  {
    return create(function (childs)
    {
      with (obj) {
        var arr2 = fields;
        for (var index in arr2) if (_hasProp.call(arr2, index)) {
          field = arr2[index];
          (function () {
            var attrs = [];
            (function () {
                    ...
                    childs.push(create('label', attrs, function (childs) {
                      (function () {
                        ...
                        childs.push(create('select', attrs, function (childs) {
                          ...
                          var arr3 = types;
                          for (var type in arr3) if (_hasProp.call(arr3, type)) {
                            type = arr3[type];
                            (function () {
                              var attrs = [];
                              (function () {
