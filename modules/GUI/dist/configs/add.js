...
AddView.on("open-configs-modal", function(index, field, fields) {
  ...
  if (models[field.type].setFields != null) {
    return models[field.type].setFields(fields);
  }
});
...
module.exports = View("ConfigsAddView", {
  ...
  clickBtnConfigField: function(e) {
    return this.trigger("open-configs-modal", this.getRowIndex(e), AddModel.getFieldByIndex(this.getRowIndex(e)), AddModel.getFields());
  },
